  ...
  return (
    <>
      <Layout>
        ...
        <h1 className="p-2 mt-5 text-lg border-4 shadow-xl border-black">Explore Available Categories</h1>
        </div>
        ...
        <div
          ...
          <div
            ...
            <div className="grid grid-cols-2 w-[100%] md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-10 mt-5  md:p-0">
              {products.length > 0 ? (
