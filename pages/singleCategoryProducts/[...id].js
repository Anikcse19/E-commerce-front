    ...
    <>
      ...
      <div className="px-20 pt-10 grid grid-cols-7 gap-4">
        {
          categories.map(category=>(
            <div onClick={()=>handleCategory(category._id)} className="border border-gray-400 cursor-pointer text-center rounded-xl py-1 px-2">{category?.name}</div>
          ))
        }
      ...
      {/* <Center> */}
        ...
        >
          ...
          <div
            id="search-options"
            className=" min-w-[18rem] flex flex-col  self-start gap-1"
          >
          ...
          <div id="search-result" className="flex-grow self-start flex flex-col gap-5">

            <div id="cat_name" className="px-3 py-2 bg-white border border-black rounded-md "> 
