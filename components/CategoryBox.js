...
const CategoryBox = ({ category }) => {
  ...
  return (
    <div
      ...
      // }}
      className="group rounded-md cursor-pointer  col-span-1 text-center px-3 py-9 flex items-center justify-center"
    >
      <div className="flex flex-col items-center justify-center gap-2">
        {category.name == "Mobiles" ? (
          <img
            className="w-[200px] h-[200px] rounded-full bg-cover group-hover:scale-110 transition-all duration-300 ease-in-out group-hover:rotate-[360deg] "
            src="/mobile.jpeg"
            alt="mobile-image"
          />
        ...
        <p className="py-2 text-base md:text-lg lg:text-xl font-bold">
          {category.name}
        </p>
      </div>
    </div>
